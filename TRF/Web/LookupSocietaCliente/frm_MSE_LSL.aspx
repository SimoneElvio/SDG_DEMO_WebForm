<%@ Page Language="C#" Inherits="Web_LookupSocietaCliente_frm_MSE_LSL" CodeBehind="frm_MSE_LSL.aspx.cs" AutoEventWireup="True" %>
...
<head id="headEditor" runat="server">
    ...
    <title>Editor Societa Cliente</title>
                            ...
                            <div class="card">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <asp:Button ID="ButtonAnnulla" CssClass="btn btn-secondary m-l-5 pull-right" runat="server" UseSubmitBehavior="False" OnClientClick="top.parent.viewSocieta();" />
                                    ...
                                    <div class="row">
                                        ...
                                        <div id="divDescrizione" runat="server" class="col-md-12">
                                            <div class="row form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="controls">
                                                        <input id="txtDescrizione" type="text" runat="server" class="form-control" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

                                        <div id="divSigla" runat="server" class="col-md-12">
                                            <div class="row form-group">
                                                <label id="LabelSigla" runat="server" class="control-label col-md-4"></label>
                                                <div class="col-md-8">
                                                    <div class="controls">
                                                        <input id="txtSigla" type="text" runat="server" class="form-control" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                         ...
                                         <div id="divFlagEliminato" runat="server" class="col-md-12">
                                            <div class="row form-group">
                                                <label id="LabelFlagEliminato" runat="server" class="control-label col-md-4"></label>
                                                <div class="col-md-8">
                                                    <div class="controls">
                                                        <asp:CheckBox ID="txtFlagEliminato" runat="server"  />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
