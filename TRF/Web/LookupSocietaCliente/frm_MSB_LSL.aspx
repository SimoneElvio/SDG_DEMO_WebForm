<%@ Page Language="C#" CodeBehind="frm_MSB_LSL.aspx.cs" Inherits="Web_LookupSocietaCliente_frm_MSB_LSL" AutoEventWireup="True" %>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <MyAsp:MyGridView ID="GridViewClientiSocieta" runat="server" AllowPaging="True" AllowSorting="True"
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderStyle-CssClass="colBtn">
                                                <ItemTemplate>
                                                     <MyLinkButton:skmLinkButton ID="ButtonDeleteRowItem" runat="server" CommandName="DELETE_COMMAND" ConfirmMessage="DELETE RECORD?" ShowConfirm="True" StatusBarText="Deleting record" CausesValidation="False"></MyLinkButton:skmLinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderStyle-CssClass="colBtn">
                                                <ItemTemplate>
                                                     <asp:LinkButton ID="ButtonEditRowItem" class="buttonRowBrowser" runat="server" />
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:BoundField DataField="LSL_ID_SOCIETA_CLIENTE" SortExpression="LSL_ID_SOCIETA_CLIENTE" Visible="false"  />
                                            <asp:BoundField DataField="CLI_ID_CLIENTE" SortExpression="CLI_ID_CLIENTE" Visible="false"  />
                                            <asp:BoundField DataField="LSL_DESCRIZIONE" SortExpression="LSL_DESCRIZIONE" Visible="true"  />
                                            <asp:BoundField DataField="LSL_SIGLA" SortExpression="LSL_SIGLA" Visible="true"  />
                                           
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:CheckBox runat="server" ID="LSL_FLAG_ELIMINATO" Checked='<%# (DataBinder.Eval(Container.DataItem,"LSL_FLAG_ELIMINATO").ToString()== "1") ? true: false %>' Enabled="false" />
                                                </ItemTemplate>
